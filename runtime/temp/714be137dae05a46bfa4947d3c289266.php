<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"admin_themes\guestbook\edit.html";i:1481882753;s:22:"admin_themes\base.html";i:1520254281;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/guestbook/index'); ?>">留言管理</a></li>
            <li class="layui-this">回复留言</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/guestbook/update'); ?>" method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label">留言内容</label>
                        <div class="layui-input-block">	
							  
							  <textarea name="bookcontent" lay-verify="bookcontent" placeholder="" class="layui-textarea"><?php echo $guestbook['content']; ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="layui-input-block">	
							 <textarea name="replycontent" lay-verify="replycontent" placeholder="" class="layui-textarea"><?php echo $guestbook['replycontent']; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="status" value="1" title="启用" <?php if($guestbook['status']==1): ?> checked="checked"<?php endif; ?>>
                            <input type="radio" name="status" value="0" title="禁用" <?php if($guestbook['status']==0): ?> checked="checked"<?php endif; ?>>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
